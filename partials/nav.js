...
function renderNav() {
  ...
  return [
    ...
    `        <li class="nav-phone-mobile"><a href="sms:${site.phoneDigits}"><span class="nav-contact-label">Text</span> ${site.phone}</a></li>`,
    '      </ul>',
    '      <div class="nav-contact">',
    `        <a href="sms:${site.phoneDigits}"><span class="nav-contact-label">Text</span> ${site.phone}</a>`,
    '      </div>',
