...
var availableItems = [
  {
    ...
    description: "The Aris is a Crate & Barrel exclusive \u2014 the piece the brand builds when the brief is modern lines without a hard seat. Clean-lined track arms and broad decks keep the profile tailored and architectural, but the bench seats and deep back cushions do the opposite of what a low, squared-off sectional usually does: they invite you to sink in.\n\nThis is the two-piece configuration \u2014 a left-arm sofa with a right-arm chaise, forming a right-facing L. At 109 inches across with the chaise running 69 inches deep, it is a room-defining piece rather than an apartment sectional. The Thrive Ink upholstery reads as a deep heathered denim-slate that shifts with the light: a textured basketweave rather than a flat weave, with real tonal variation up close.",
    features: [
