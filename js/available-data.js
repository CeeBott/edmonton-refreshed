...
var availableItems = [
  {
    ...
    faq: [
      ...
      { question: "Is this the current Lounge, the Lounge II, or the Lounge Deep?", answer: "This is the current-generation Lounge — the model Crate & Barrel sells today, label-dated May 2024. It is not the discontinued Lounge II, and it is not the Lounge Deep, which is a deeper-profile variant. This is the standard Lounge at 41 inches deep with a 24-inch seat depth, in the 83-inch bench-cushion configuration." },
    ...
    retailEstimate: 3057,
    price: 1700,
    specs: ["Crate & Barrel", "83 × 41 × 37 in", "Seat Depth: 24 in", "Seat Height: 18 in", "Taft Steel Everweave", "Made in USA", "Two Available", "Like New"],
    images: [
