...
var availableItems = [
  {
    ...
    metaDescription: "Two pre-owned Crate & Barrel Lounge bench sofas in grey Taft Steel weave. Sold individually, inspected and cleaned. Delivery across Alberta. $1,700 CAD.",
    ...
    condition: "Excellent pre-owned condition on both sofas. The Taft weave is clean and even with no visible wear, and the bench cushion and feather-down back cushions hold their shape and loft. The manufacturer's law label is intact and dated May 2024 — these were barely two years old at listing. Photos show one of the two sofas; they are identical.",
    ...
    faq: [
      { question: "Is this an authentic Crate & Barrel Lounge sofa?", answer: "Yes. The original manufacturer's label is attached and confirms the piece: made for Crate & Barrel in Conover, North Carolina, in the Taft Steel fabric, with a May 2024 date. Every designer piece we list is inspected for construction, materials, and manufacturer consistency before going up." },
    ...
    retailEstimate: 3057,
    price: 1700,
    specs: ["Crate & Barrel", "83 × 41 × 37 in", "Taft Steel Everweave", "Made in USA", "Two Available", "Excellent Condition"],
    images: [
