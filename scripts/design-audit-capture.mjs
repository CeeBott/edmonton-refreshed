...
const PAGES = [
  ...
  { path: '/listings/pottery-barn-turner-square-arm-sofa-edmonton/', name: 'listing-pottery-barn' },
  { path: '/listings/bracci-como-maxi-apartment-sofa-edmonton/', name: 'listing-bracci' },
  { path: '/listings/la-z-boy-roundabout-ottoman-edmonton/', name: 'listing-ottoman' },
